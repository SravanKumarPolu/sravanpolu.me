...
const buttonVariants = {
  base: "inline-flex items-center justify-center font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent disabled:opacity-50 disabled:cursor-not-allowed transform-gpu min-h-[44px] min-w-[44px]",
  variants: {
    size: {
      xs: "px-3 py-2 text-xs gap-1.5 rounded-md min-h-[32px]",
      sm: "px-4 py-2.5 text-sm gap-2 rounded-lg min-h-[36px]",
      md: "px-4 py-2 text-base gap-2 rounded-lg min-h-[44px]",
      lg: "px-6 py-3 text-lg gap-3 rounded-xl min-h-[48px]",
      xl: "px-8 py-4 text-xl gap-4 rounded-xl min-h-[52px]",
    },
    variant: {
