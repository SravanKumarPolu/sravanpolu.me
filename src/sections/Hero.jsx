...
const Hero = () => {
  return (
    <section
      id="home"
      className="w-full flex flex-col items-center justify-center min-h-screen gap-10 max-container bg-gradient-to-br from-[rgba(245, 246, 252, 0.52)] to-[rgba(117, 19, 93, 0.73)]">
      ...
      <div className="relative flex flex-col justify-center items-center w-full max-xl:px-10 pt-10">
        <h3 className="pt-6 font-palanquin text-4xl md:text-5xl max-sm:text-2xl max-sm:leading-[2] font-semibold text-center text-coral-red">
          Hi,{" "}
          ...
          <span className="font-montserrat text-2xl md:text-3xl text-coral-red">
            Web Developer
          </span>
        </h3>
